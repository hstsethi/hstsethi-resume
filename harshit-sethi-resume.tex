...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    % \textbf{Frameworks}{: Express.js, } \\
         ...
         \textbf{Skills}{: SEO, Equity Investing(Cap 1.10k+ INR at 18), \href{https://hstsethi.vercel.app/posts/finance/from-coins-to-25-equity-at-18}{memoir}), Linux Command Line, Regular Expressions, Leadership Skills(Found 8+ tech, educational groups, \href{https://hstsethi.vercel.app/posts/lifestyle/lessons-learned-founding-internet-groups-memoir}{memoir})} \\ 
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
     ...
     \resumeItem{Improved multilingual model search process by identifying and reporting lack of multilingual tags in Mistral 2407. Supported claim with official model card, MMLU benchmarks, and personal testing in Hindi, Punjabi with literary works.}
\resumeItemListEnd
\resumeSubheading
...
\resumeItemListStart
    \resumeItem{Created 4 CSV dataset, charts, machine learning, database lookup based Python program about mobile number prefixes in India. Got featured in Awesome OSINT(20,000+ stars). Utilized Jupyter, Matplotlib for visualizations. Scikit-learn, Pandas, Numpy for machine learning. Preprocessed raw data using various techniques including Pandas, Microsoft Excel, SQL, Regular Expressions.}
    ...
    \resumeItem{Achieved \textbf{15\%} increase in accuracy by using a combination of dataset lookup, 4 pre-trained, loadable, specialized gradient boosting classifiers models(GBC).}
